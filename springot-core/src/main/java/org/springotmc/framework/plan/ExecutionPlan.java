...
import org.springotmc.framework.plan.task.PlannedMethodTask;
...
public class ExecutionPlan {
    ...
    private final SpringotFramework platform;
    ...
    public static <T extends SpringotFramework> ExecutionResult dispatch(@NonNull T platform) {
