...
import org.springotmc.commons.cache.CacheMap;
import org.springotmc.commons.spliterator.EnumerationSpliterator;
...
public class ClasspathScanner {
    ...
    private static final boolean TRACE = Boolean.parseBoolean(System.getProperty("springot.framework.trace", "false"));
